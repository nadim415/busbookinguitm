...
<body > 
        ...
        <div class="right">
           ...
           <h3>Account Information</h3><hr/><br/> <b> 
                ...
                <h3></h3><hr/><br>
				<a href="viewBus.php"><button class="btn3">Back</button></a>
                <a href="updateProfile.php?id=<?php echo $user_data['id'];?>"><button class="btn3">Update</button></a>				            
                <a href="logout.php"><button class="btn3">Logout</button></a>
                <a href="deleteProfile.php?id=<?php echo $user_data['id'];?>"><button class="btn3">Delete</button></a></b>
         </div>
