    ...
    $sqlgetPrice = "SELECT cost FROM route WHERE id = $route_id";
    $sqldataPrice = mysqli_query($conn, $sqlgetPrice) or die('error getting price');

    $defaultAmount = 200.00;

    if ($rowPrice = mysqli_fetch_array($sqldataPrice, MYSQLI_ASSOC)) {
        $defaultAmount = $rowPrice['cost'];
    }
    ?>
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="inputBox">
                        ...
                        <input type="number" value="<?php echo $defaultAmount; ?>" name="amount">       
                    </div>	
